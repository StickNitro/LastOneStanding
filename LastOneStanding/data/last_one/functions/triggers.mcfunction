# scoreboard players set @a LastOneRole 0
# scoreboard players enable @a LastOneRole
# scoreboard players set @a LastOneContender 0
# scoreboard players enable @a LastOneContender

scoreboard players set @a LastLifeVers 0
scoreboard players enable @a LastLifeVers
scoreboard players set @a LastLifeBorder 0
