...
execute at @e[type=falling_block,tag=LastLifeEnchanter] unless block ~ ~-2 ~ air run setblock ~ ~-1 ~ minecraft:structure_block{posX:-3,posY:-1,posZ:-3,sizeX:7,sizeY:10,sizeZ:7,mode:"LOAD",name:"lastone:lastone_enchant",powered:0b} replace
